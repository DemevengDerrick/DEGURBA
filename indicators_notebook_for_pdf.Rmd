...
pacman::p_load(tidyverse, # data manipulation
               haven, # 
               forcats, 
               gt, # great tables package to style tabular data
               sf, # simple feature to read basic shapefiles
               ggrepel, # manage lebelling positioning
               patchwork, # paste different visuals together
               knitr # package required to generate pdf documents
               )
```
...
demographics |>
  ...
  ggplot2::labs(title = "Age - Sex Distribution",
                ...
                fill = "Sex") +
  ggplot2::theme_minimal() +
  ggplot2::scale_y_discrete(breaks = seq(0, 100, 10)) +
  ggplot2::theme(
...
constituency_shape |>
  ...
  ggplot2::ggplot() +
  ggplot2::geom_sf(aes(fill = pop), color = "black") +
...
**Step 2 : SDG disagregation by DEGURBA**
